## Дипломная работа - Интернет - магазин SitDownPls
...
Запустите команду `npm i`, которая установит все зависимости.
Для сборки необходимо использовать одну из команд сборки:
